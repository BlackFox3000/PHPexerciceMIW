...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 31 oct. 2019 à 16:23
...
('ATA', 'Antarctica', 'Antarctica', 'Antarctica', 1.00, NULL, 0, NULL, 0.00, NULL, '–', 'Co-administrated', '', NULL, 'AQ'),
...
CREATE TABLE IF NOT EXISTS `gallery` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_foreign_key_name` (`countrycode`)
...
INSERT INTO `gallery` (`id`, `countrycode`, `name`, `description`) VALUES
(7, 'CAN', 'Raptors', 'Logo des Toronto Raptors'),
(8, 'FRA', 'Vignoble', 'Vignoble');
